...
Original file is located at
    https://colab.research.google.com/drive/1sqcyPYP8qq7doTun18xfBmiUec4YjlmH
"""
#This is use only when running on Colab
'''
...
from InsightModel import InsightModel
from dataset_InsightModel import graphData, trans_to_cuda
from dataset_InsightModel import get_insight, get_batch, build_vocab

parser = argparse.ArgumentParser(description='Insight Training')
# ========
# PLease change the data path accordingly
# ========
parser.add_argument("--insightpath", default='/content/drive/MyDrive/Colab Notebooks/data/train-test_data/', help="Insight data path")
parser.add_argument("--word_emb_path", default='/content/drive/MyDrive/Colab Notebooks/glove.6B.100d.txt')
parser.add_argument("--word_emb_dim", type=int, default=100, help="word embedding dimension")
parser.add_argument("--outputdir", type=str, default='/content/drive/MyDrive/Colab Notebooks/checkpoint/Insight', help="Output directory")
parser.add_argument("--outputmodelname", type=str, default='model.pickle')
parser.add_argument("--unum2id", default="/content/drive/MyDrive/Colab Notebooks/data/step1_data/unum2id.json")
parser.add_argument("--jnum2id", default="/content/drive/MyDrive/Colab Notebooks/data/step1_data/jnum2id.json")
parser.add_argument("--jd_json", default="/content/drive/MyDrive/Colab Notebooks/data/step1_data/exp_morethan_50_graph/jd.json")
parser.add_argument("--user_json", default="/content/drive/MyDrive/Colab Notebooks/data/step1_data/exp_morethan_50_graph/user.json")
...
# These two are number of vocabulary input in nn.Embedding, may need to be tuned
...
word_vec['<s>'] = np.random.rand(100)
word_vec['</s>'] = np.random.rand(100)
word_vec['<p>'] = np.random.rand(100)
...
# optimizer
optim_fn, optim_params = get_optimizer('sgd,lr=0.01')
